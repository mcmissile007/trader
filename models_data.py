...
model['sleep_time'] = 14  + len(models)
model['log_file_name'] = "trader_USDC_BCHSV_"
model['initial_base_balance_to_simulate'] = 10000.0
model['initial_amount_to_buy_in_base'] = 100.0  
model['min_amount_to_buy_in_base'] = 1.1 
model['max_amount_to_buy_in_base'] = 1000000.0
model['sos_amount'] = 200.0
model['sos_rate'] = 0.01
...
model['sleep_time'] = 16  + len(models)
model['log_file_name'] = "trader_USDC_XMR_"
model['initial_base_balance_to_simulate'] = 10000.0
...
model['sleep_time'] = 18  + len(models)
