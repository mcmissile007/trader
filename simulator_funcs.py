...
def sim_buy_now (logger,local_data_base_config,currency_pair,time_frame,rate,amount,purchase_operations,base_balance,quote_balance,now,lowestAsk):
...
def sim_buy_in_base (logger,local_data_base_config,currency_pair,close,increment,time_frame,output_rsi,model,purchase_operations,trade_operations,base_balance,quote_balance,now,repurchases,last,lowestAsk):
...
def sim_sell_SOS (logger,local_data_base_config,currency_pair,close,increment,time_frame,candle_rsi,output_rsi,always_win,min_current_rate_benefit,max_amount_to_buy_in_base,base_balance,purchase_operations,trade_operations,quote_balance,now,sos_model_benefit,sos_games,last,highestBid):
    ...
    logger.debug("last rate:{}".format(last))
